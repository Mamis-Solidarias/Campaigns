...
namespace MamisSolidarias.WebAPI.Campaigns.Migrations
{
    ...
    [Migration("20230117142338_AdoptedNewJuntosBaseClass")]
    partial class AdoptedNewJuntosBaseClass
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MamisSolidarias.Infrastructure.Campaigns.Models.JuntosALaPar.JuntosCampaign", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MamisSolidarias.Infrastructure.Campaigns.Models.JuntosALaPar.JuntosParticipant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MamisSolidarias.Infrastructure.Campaigns.Models.Mochi.MochiCampaign", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MamisSolidarias.Infrastructure.Campaigns.Models.Mochi.MochiParticipant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MamisSolidarias.Infrastructure.Campaigns.Models.JuntosALaPar.JuntosParticipant", b =>
                {
                    b.HasOne("MamisSolidarias.Infrastructure.Campaigns.Models.JuntosALaPar.JuntosCampaign", null)
                        .WithMany("Participants")
                        .HasForeignKey("CampaignId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MamisSolidarias.Infrastructure.Campaigns.Models.Mochi.MochiParticipant", b =>
                {
                    b.HasOne("MamisSolidarias.Infrastructure.Campaigns.Models.Mochi.MochiCampaign", null)
                        .WithMany("Participants")
                        .HasForeignKey("CampaignId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
